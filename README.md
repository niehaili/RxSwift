...
target 'YOUR_TARGET_NAME' do
    pod 'RxSwift', '6.5.0-cml'
    pod 'RxCocoa', '6.5.0-cml'
end

# RxTest and RxBlocking make the most sense in the context of unit/integration tests
target 'YOUR_TESTING_TARGET' do
    pod 'RxBlocking', '6.5.0-cml'
    pod 'RxTest', '6.5.0-cml'
end
```
...
```
github "ReactiveX/RxSwift" "6.5.0-cml"
```
...
let package = Package(
  name: "RxTestProject",
  dependencies: [
    .package(url: "https://github.com/ReactiveX/RxSwift.git", .exact("6.5.0-cml"))
  ],
  targets: [
